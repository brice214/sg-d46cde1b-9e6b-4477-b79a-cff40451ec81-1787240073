  ...
  return (
    <section id="contact" className="section-padding bg-muted relative overflow-hidden">
      ...
      <div className="container relative z-10">
        <div className="grid lg:grid-cols-[38%_1fr] gap-12 lg:gap-16">
          {/* Logo à gauche */}
          <div className="hidden lg:flex items-stretch">
            <div className="relative w-full h-full bg-white rounded-lg border border-border shadow-sm p-12 flex items-center justify-center">
